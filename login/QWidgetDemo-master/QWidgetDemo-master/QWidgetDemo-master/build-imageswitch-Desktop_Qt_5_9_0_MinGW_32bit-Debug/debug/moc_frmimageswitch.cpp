...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_frmImageSwitch_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_frmImageSwitch_t qt_meta_stringdata_frmImageSwitch = {
    {
QT_MOC_LITERAL(0, 0, 14), // "frmImageSwitch"
QT_MOC_LITERAL(1, 15, 8), // "initForm"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "frmImageSwitch\0initForm\0"
};
...
void frmImageSwitch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        frmImageSwitch *_t = static_cast<frmImageSwitch *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject frmImageSwitch::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_frmImageSwitch.data,
      qt_meta_data_frmImageSwitch,  qt_static_metacall, nullptr, nullptr}
};
...
void *frmImageSwitch::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_frmImageSwitch.stringdata0))
        return static_cast<void*>(const_cast< frmImageSwitch*>(this));
