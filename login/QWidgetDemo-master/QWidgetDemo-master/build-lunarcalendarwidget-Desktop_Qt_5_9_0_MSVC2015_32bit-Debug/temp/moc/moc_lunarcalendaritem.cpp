...
#include "../../../lunarcalendarwidget/lunarcalendaritem.h"
...
void LunarCalendarItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LunarCalendarItem *_t = static_cast<LunarCalendarItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (LunarCalendarItem::*_t)(const QDate & , const LunarCalendarItem::DayType & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LunarCalendarItem::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject LunarCalendarItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LunarCalendarItem.data,
      qt_meta_data_LunarCalendarItem,  qt_static_metacall, nullptr, nullptr}
};
...
void *LunarCalendarItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LunarCalendarItem.stringdata0))
        return static_cast<void*>(const_cast< LunarCalendarItem*>(this));
