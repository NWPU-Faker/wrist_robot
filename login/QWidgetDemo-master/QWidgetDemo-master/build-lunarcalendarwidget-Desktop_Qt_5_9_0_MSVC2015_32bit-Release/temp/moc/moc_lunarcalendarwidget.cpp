...
void LunarCalendarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LunarCalendarWidget *_t = static_cast<LunarCalendarWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (LunarCalendarWidget::*_t)(const QDate & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LunarCalendarWidget::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (LunarCalendarWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LunarCalendarWidget::selectionChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject LunarCalendarWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LunarCalendarWidget.data,
      qt_meta_data_LunarCalendarWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *LunarCalendarWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LunarCalendarWidget.stringdata0))
        return static_cast<void*>(const_cast< LunarCalendarWidget*>(this));
