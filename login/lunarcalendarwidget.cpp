...
LunarCalendarWidget::LunarCalendarWidget(QWidget *parent) : QWidget(parent)
{
    ...
    if (!fontDb.families().contains("FontAwesome")) {
        int fontId = fontDb.addApplicationFont(":/new/prefix1/fontawesome-webfont.ttf");
    ...
    showLunar = true;
    bgImage = ":/new/prefix1/bg_calendar.png";
    selectType = SelectType_Triangle;
...
void LunarCalendarWidget::initWidget()
{
    ...
    btnPrevYear->setStyleSheet("background-color: rgb(200, 200, 200);font-size:30pt;color:#16A085;border-radius:10px");

    //下一年按钮
    QToolButton *btnNextYear = new QToolButton;
    btnNextYear->setObjectName("btnNextYear");
    btnNextYear->setFixedWidth(55);
    ...
    btnNextYear->setStyleSheet("background-color: rgb(200, 200, 200);font-size:30pt;color:#16A085;border-radius:10px");

    //上个月按钮
    QToolButton *btnPrevMonth = new QToolButton;
    btnPrevMonth->setObjectName("btnPrevMonth");
    btnPrevMonth->setFixedWidth(55);
    ...
    btnPrevMonth->setStyleSheet("background-color: rgb(200, 200, 200);font-size:30pt;color:#16A085;border-radius:10px");

    //下个月按钮
    QToolButton *btnNextMonth = new QToolButton;
    btnNextMonth->setObjectName("btnNextMonth");
    btnNextMonth->setFixedWidth(55);
    ...
    btnNextMonth->setStyleSheet("background-color: rgb(200, 200, 200);font-size:30pt;color:#16A085;border-radius:10px");
    ...
    btnToday->setStyleSheet("background-color: #16A085;font-size:25pt;color:#FFFFFF;border-radius:18px");

    //年份下拉框
    cboxYear = new QComboBox;
    cboxYear->setMinimumHeight(45);
    cboxYear->setStyleSheet("font-size:23pt;color:rgb(0, 117, 172)");
    ...
    cboxMonth->setMinimumHeight(45);
    cboxMonth->setStyleSheet("font-size:23pt;color:rgb(0, 117, 172)");
    ...
    widgetWeek->setMinimumHeight(45);
    widgetWeek->setStyleSheet("background-color:#16A085;font-size:22pt;color:#FFFFFF");
    //星期布局
