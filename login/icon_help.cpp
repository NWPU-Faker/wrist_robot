...
void IconHelper::initFont()
{
    ...
    if (!isInit) {
        ...
        if (iconFontAliBaBa == 0) {
            iconFontAliBaBa = new IconHelper(":/new/prefix1/fontawesome-webfont.ttf", "iconfont");
        }
        if (iconFontAwesome == 0) {
            iconFontAwesome = new IconHelper(":/new/prefix1/fontawesome-webfont.ttf", "FontAwesome");

            //iconFontAwesome = new IconHelper(":/image/iconfont.ttf", "FontAwesome");
        }
    }
}
